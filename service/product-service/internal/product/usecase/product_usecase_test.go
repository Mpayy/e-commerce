...
// 	// Helper function untuk generate instance produk baru di tiap sub-test
// 	getFreshProduct := func() *entity.Product {
// 		return &entity.Product{
// 			ID:          productID,
// 			CategoryID:  uint(1), // Kategori awal berbeda dengan request (1 != 2)
...
// 		// Samakan CategoryID agar cabang ValidateCategoryExists dilewati
// 		reqSameCategory := &dto.ProductUpdateRequest{
// 			CategoryID:  product.CategoryID, // Same Category ID (1)
// 			Name:        "Updated Name Same Category",
// 			Description: "Updated Desc",
// 			Price:       20000,
// 			Stock:       50,
// 			SKU:         "",  // Empty SKU branch
// 			IsActive:    nil, // Nil IsActive branch
// 		}
...
// 				p.SKU == "PROD-OLD-001" && // SKU tidak berubah
// 				p.IsActive == false // IsActive tidak berubah
// 		})).Return(nil)
...
// 	// go test -v ./internal/product/usecase -run "TestProductUsecaseImpl_SearchProducts/success_search_products_with_default_page_and_limit"
// 	t.Run("success_search_products_with_default_page_and_limit", func(t *testing.T) {
// 		uc, repo, _ := setupProductUsecase(t)

// 		// Request dengan Page & Limit <= 0 untuk menguji cabang default pagination
// 		reqInvalidPagination := &dto.ProductSearchRequest{
// 			Search:     "Baju",
// 			CategoryID: uint(1),
// 			Page:       0,  // Harusnya diubah jadi 1 oleh Usecase
// 			Limit:      -5, // Harusnya diubah jadi 10 oleh Usecase
// 		}
...
// 	// go test -v ./internal/product/usecase -run "TestProductUsecaseImpl_GetProductDetail/failed_product_record_not_found"
...
// 		// Repo mengembalikan ErrRecordNotFound, Usecase melakukan mapping ke ErrProductNotFound
// 		repo.EXPECT().AdjustStock(mock.Anything, productID, newStock).
// 			Return(apperror.ErrRecordNotFound)
...
// 		repo.EXPECT().DecreaseStock(mock.Anything, productID, quantity).Return(nil)

// 		err := srv.DecreaseStock(ctx, productID, quantity)
// 		assert.NoError(t, err)
// 	})
...
// 		repo.EXPECT().DecreaseStock(mock.Anything, productID, quantity).
// 			Return(apperror.ErrRecordNotFound)
