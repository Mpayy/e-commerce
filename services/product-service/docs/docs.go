        ...
        "/admin/categories": {
            "post": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "DUPLICATED_CATEGORY",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.ErrorResponse"
        ...
        "/admin/products": {
            "post": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "DUPLICATED_PRODUCT / DUPLICATED_PRODUCT_SKU",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.ErrorResponse"
        ...
        "/admin/products/{product_id}": {
            "put": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "PRODUCT_NOT_FOUND / CATEGORY_NOT_FOUND",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.ErrorResponse"
        ...
        "/admin/products/{product_id}/image": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "BAD_REQUEST / INVALID_FILE_TYPE / FILE_TOO_LARGE",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.ErrorResponse"
